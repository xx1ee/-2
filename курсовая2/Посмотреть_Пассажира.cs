...
namespace курсовая2
{
    public partial class Посмотреть_Пассажира : Form
    {
        ...
        public string s1 = "";
        public DataGridViewCell cell_pass_id;
        public Посмотреть_Пассажира()
        {
            InitializeComponent();
        ...
        {
            cell_pass_id = dataGridView1.Rows[Convert.ToInt32(s1) - 1].Cells[0];
            this.Close();
        }
    }
}
